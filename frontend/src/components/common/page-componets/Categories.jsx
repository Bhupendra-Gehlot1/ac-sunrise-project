    ...
    <div className="pt-10 pb-16">
      <div className="grid grid-cols-1 gap-16 sm:grid-cols-2 md:grid-cols-4">
        <div className="md:col-span-1">
          <h1 className="sub-heading">Expansion</h1>
          <h1 className="heading">
            Continuously Expanding, Continuously Building
          </h1>
          <p className="mt-3">
            We are continuously trying to achieve new heights while maintaining
            the highest ethical standards and also being conscious of the impact
            our work has on creating a better tomorrow, a better World.
          </p>
