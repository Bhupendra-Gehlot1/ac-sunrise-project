      ...
      <div className="flex flex-wrap gap-24">
        ...
        <div className="relative flex-1 basis-[22rem]">
          ...
          <h1 className="heading">
            We Unlock the Perfect Space for Health, Hospitality, and Happiness
          </h1>
          <p className="mt-3">
            AP Sunrise LLC, a leading commercial and residential estate company
            based in South Carolina, USA. With a steadfast focus on the
            Healthcare and Hospitality industries, we are dedicated to
            transforming spaces into remarkable environments that foster
            excellence and enhance experiences for our esteemed clients.
          </p>
          <div className="mt-4">
