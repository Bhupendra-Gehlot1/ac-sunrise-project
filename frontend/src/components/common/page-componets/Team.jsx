  ...
  return (
    <div className="pt-10 pb-16">
      <div className="text-center">
        ...
        <h1 className="heading">Meet Our Management</h1>
        <p>
          Without a capable captain at the helm, the ship falters. We are proud
          to have such able leadership guiding us with their vision.
        </p>
      </div>
      <div>
