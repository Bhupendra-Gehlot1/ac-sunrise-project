...
export const brands = [
  ...
  "/images/brands/atiPhysicalTherapy.png",
  "/images/brands/prismaHealthCare.png",
];

export const focus = [
  {
    id: 1,
    name: "Change And Innovation",
    icon: <FaLightbulb />,
    text: "Ideas before Results. We believe in embracing change to stimulate creativity and ingenuity that is central to bringing new products and services for our clients.",
  },
  {
    id: 2,
    name: "Customer centercity",
    icon: <FaHandshake />,
    text: "Strive to add value and inspire our customers because we recognize that they come to us by choice.",
  },
  {
    id: 3,
    name: "Integrity",
    icon: <SiHandshake />,
    text: "We uphold the highest standards of integrity in all of our actions.",
  },
  {
    id: 4,
    name: "Collaboration",
    icon: <RiTeamFill />,
    text: "Work as one “We harness differences and interdependencies to unleash the power of one.”",
  },
  {
    id: 5,
    name: "Efficiency And Excellence",
    icon: <BiMedal />,
    text: "We focus on results, act with ambition to be operationally competitive.",
  },
  {
    id: 6,
    name: "Responsibility",
    icon: <FaHandHoldingUsd />,
    text: "We are willing to take responsibility for our actions and their impact.",
  },
];
